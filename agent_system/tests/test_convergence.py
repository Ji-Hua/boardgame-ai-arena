...
Phase 2+3 of the Agent System SSOT convergence. These tests verify:
    ...
    B. agent_system/definition/agent_defs/ is the canonical source for both consumers
...
from agent_system.definition.agent_spec import AgentSpec as SharedAgentSpec, load_agent_specs_from_dir
from agent_system.runtime.service.yaml_loader import (
    AgentDefinition,
    load_definitions_from_dir,
)
from agent_system.evaluation.arena.agents.loader import (
    _SCORER_REGISTRY,
    load_agent,
    load_agents_from_dir,
    materialize_agent,
)
from agent_system.evaluation.arena.agents.core import Agent as ArenaAgent
...
_CANONICAL_DIR = _REPO_ROOT / "agent_system" / "definition" / "agent_defs"
...
class TestCanonicalDirectory:
    """agent_system/definition/agent_defs/ is the single source for both Arena and Agent Service."""
...
class TestAgentServiceFiltering:
    ...
    def test_unmaterializable_specs_not_in_service(self):
        ...
        from agent_system.runtime.service.yaml_loader import _AGENT_BUILDERS
