...
Covers:
    ...
    B. Directory loading tests
       - agent_system/definition/agent_defs/ (canonical YAML source, 11 files)
...
from agent_system.definition.agent_spec import AgentSpec, load_agent_spec, load_agent_specs_from_dir, parse_agent_spec
...
_CANONICAL_DEFS = _REPO_ROOT / "agent_system" / "definition" / "agent_defs"
...
class TestLoadCanonicalDir:
    """Load all YAML files from agent_system/definition/agent_defs/ (canonical source)."""
