...
from agent_system.evaluation.arena.aggregator import compute_win_rate_matrix, format_matrix_text
from agent_system.evaluation.arena.runner import play_single_game, ArenaRunner
...
# ---------------------------------------------------------------------------
# Agent YAML directory — canonical source in agent_system/definition/agent_defs/
# ---------------------------------------------------------------------------
