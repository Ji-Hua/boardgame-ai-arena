...
# Arena imports
# ---------------------------------------------------------------------------
from agent_system.evaluation.arena.agents.core import Agent, AgentInstance, Policy, TopKPolicy
from agent_system.evaluation.arena.agents.loader import load_agent
from agent_system.evaluation.arena.runner import play_single_game

# ---------------------------------------------------------------------------
# Agent service imports
# ---------------------------------------------------------------------------
from agent_system.runtime.service.policy import (
...
from agent_system.runtime.service.yaml_loader import load_definition

_AGENT_DIR = Path(__file__).resolve().parent.parent.parent.parent / "definition" / "agent_defs"
