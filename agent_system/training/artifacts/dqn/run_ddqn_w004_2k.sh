#!/usr/bin/env bash
# Phase 17A: Double DQN 2k run — distance_delta, weight=0.04, [256,256]
set -euo pipefail
...
RUN_DIR="agent_system/training/artifacts/dqn/dqn_double_dqn_distance_delta_w004_2k_001"
...
uv run python scripts/train_dqn.py \
  ...
  --agent-id dqn_double_dqn_distance_delta_w004_2k_001 \
